          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-4 flex justify-between items-center">
            ...
            <div className="flex items-center space-x-4">
               <button
                  ...
                  className="flex items-center space-x-2 bg-white text-blue-600 border border-blue-600 font-semibold px-4 py-2 rounded-lg shadow-sm hover:bg-blue-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition-colors duration-200"
              >
                  <AnalysisIcon />
